      ...
      <section className="premium-panel p-6 md:p-8">
        ...
        {requests.length === 0 ? (
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-10 text-center">
            ...
            <p className="text-lg font-semibold text-white">AÃºn no tienes solicitudes</p>
      ...
      {cancelModalId && (
        <div className="fixed inset-0 z-50 bg-black/65">
          ...
          <div className="absolute inset-x-0 bottom-0 rounded-t-3xl border border-white/10 bg-[#0A0F1A] p-5 shadow-[0_-18px_40px_rgba(0,0,0,0.45)] md:left-1/2 md:max-w-md md:-translate-x-1/2 md:bottom-6 md:rounded-2xl">
            <h2 className="font-[var(--font-heading)] text-xl font-bold text-white">Confirmar cancelaciÃ³n</h2>
            <p className="mt-2 text-sm text-brand-muted">Esta acciÃ³n es irreversible. La solicitud pasarÃ¡ a estado CANCELADA.</p>
